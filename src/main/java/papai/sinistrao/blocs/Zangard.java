...
public class Zangard extends Block {
    ...
    public Zangard(boolean p_i45420_1_){
        ...
        {
       	 this.setBlockTextureName(PapaiSinistraoMod.MODID + ":" + "Zangard");
 		this.setHardness(30);
    ...
    private void func_150185_e(World p_150185_1_, int p_150185_2_, int p_150185_3_, int p_150185_4_)
    {
        ...
        if (this == GerenciadorDeBlocos.Zangard)
        {
            p_150185_1_.setBlock(p_150185_2_, p_150185_3_, p_150185_4_, GerenciadorDeBlocos.Zangard);
        }
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (this == GerenciadorDeBlocos.Zangard)
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, GerenciadorDeBlocos.Zangard);
        }
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return GerenciadorDeItens.ZangardItem;
    }
    ...
    {
        return new ItemStack(GerenciadorDeBlocos.Zangard);
    }
}